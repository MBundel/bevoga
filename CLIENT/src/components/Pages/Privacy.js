  ...
  return (
    <div>
      ...
      <p>
        ...
        <strong className="adsimple-312087504">Grafiken</strong> zum Einsatz
      ...
      <h2 id="anwendungsbereich" className="adsimple-312087504">
        Anwendungsbereich
      </h2>
      <p>
      ...
      <p>
        <strong className="adsimple-312087504">Kurz gesagt:</strong> Die
      ...
      <h2 id="rechtsgrundlagen" className="adsimple-312087504">
        Rechtsgrundlagen
      </h2>
      <p>
      ...
      <ol>
        ...
        <li className="adsimple-312087504">
          <strong className="adsimple-312087504">Berechtigte Interessen</strong>
      ...
      <h2 id="kontaktdaten-verantwortliche" className="adsimple-312087504">
      ...
      <h2 id="speicherdauer" className="adsimple-312087504">
        Speicherdauer
      </h2>
      <p>
      ...
      <h2 id="rechte-dsgvo" className="adsimple-312087504">
      ...
      <p>
        <strong className="adsimple-312087504">Kurz gesagt:</strong> Sie haben
      ...
      <h2 id="web-analytics-einleitung" className="adsimple-312087504">
      ...
      <h3 className="adsimple-312087504">Was ist Web Analytics?</h3>
      <p>
      ...
      <h3 className="adsimple-312087504">Warum betreiben wir Web Analytics?</h3>
      <p>
      ...
      <h3 className="adsimple-312087504">Welche Daten werden verarbeitet?</h3>
      <p>
      ...
      <h3 className="adsimple-312087504">Widerspruchsrecht</h3>
      <p>
      ...
      <h2 id="firebase-datenschutzerklaerung" className="adsimple-312087504">
      ...
      <h3 className="adsimple-312087504">Was ist Google Analytics?</h3>
      <p>
      ...
      <p>
        <strong className="adsimple-312087504">Name:</strong> _ga
        <br />
        <strong className="adsimple-312087504">Wert: </strong>
        2.1326744211.152312087504-5
        <br />
        <strong className="adsimple-312087504">Verwendungszweck:</strong>
      ...
      <p>
        <strong className="adsimple-312087504">Name:</strong> __utma
        <br />
        <strong className="adsimple-312087504">Wert: </strong>
      ...
      <p>
        ...
        <br />
        <strong className="adsimple-312087504">Wert: </strong>3.10.1564498958
        <br />
        <strong className="adsimple-312087504">Verwendungszweck:</strong> Dieses
      ...
      <p>
        ...
        <br />
        <strong className="adsimple-312087504">Wert:</strong> 167421564
        <br />
        <strong className="adsimple-312087504">Verwendungszweck:</strong> Dieses
      ...
      <p>
        <strong className="adsimple-312087504">Heatmaps:</strong> Google legt
      ...
      <p>
        <strong className="adsimple-312087504">Sitzungsdauer:</strong> Als
      ...
      <p>
        <strong className="adsimple-312087504">Absprungrate</strong> (engl.
      ...
      <ul className="adsimple-312087504">
        <li className="adsimple-312087504">Löschung nach 14 Monaten</li>
        <li className="adsimple-312087504">Löschung nach 26 Monaten</li>
        <li className="adsimple-312087504">Löschung nach 38 Monaten</li>
        <li className="adsimple-312087504">Löschung nach 50 Monaten</li>
        <li className="adsimple-312087504">Keine automatische Löschung</li>
      </ul>
      <p>
      ...
      <h2 id="e-mail-marketing-einleitung" className="adsimple-312087504">
      ...
      <h3 className="adsimple-312087504">Was ist E-Mail-Marketing?</h3>
      <p>
      ...
      <h3 className="adsimple-312087504">Warum nutzen wir E-Mail-Marketing?</h3>
      <p>
      ...
      <h3 className="adsimple-312087504">Dauer der Datenverarbeitung</h3>
      <p>
      ...
      <h2 id="cleverreach-datenschutzerklaerung" className="adsimple-312087504">
        CleverReach Datenschutzerklärung
      </h2>
      <p>
        <span
          className="adsimple-312087504"
          data-sheets-value='{"1":2,"2":"Wir verwenden auf unserer Website CleverReach, ein Dienst für unser E-Mail-Marketing."}'
          data-sheets-userformat='{"2":4865,"3":{"1":0},"11":3,"12":0,"15":"Arial, sans-serif"}'
        >
        ...
        <tbody>
          <tr>
            <td style={{color:"black"}}>
              ...
              &#x2696;&#xfe0f; Rechtsgrundlagen: Art. 6 Abs. 1 lit. a DSGVO
              (Einwilligung), Art. 6 Abs. 1 lit. f DSGVO (Berechtigte
              Interessen), Art. 6 Abs. 1 S. 1 lit. b. DSGVO (vertragliche oder
      ...
      <p>
        Wir bieten auf unserer Website verschiedene Möglichkeiten (etwa
        Messenger- und Chatfunktionen, Online- bzw. Kontaktformulare, E-Mail,
        Telefon), um mit uns zu kommunizieren. Dabei werden auch Ihre Daten,
        soweit es für die Beantwortung Ihrer Anfrage und unseren darauffolgenden
        Maßnahmen nötig ist, verarbeitet und gespeichert.
      </p>
      <p>
        Wir nutzen neben klassischen Kommunikationsmitteln wie E-Mail,
        ...
        Messenger-Funktionen anbieten. Wenn Inhalte Ende zu Ende verschlüsselt
        sind, wird darauf in den einzelnen Datenschutztexten oder in der
        Datenschutzerklärung des jeweiligen Anbieters hingewiesen. Eine
        Ende-zu-Ende-Verschlüsselung bedeutet nichts anders, als dass Inhalte
        einer Nachricht selbst für den Anbieter nicht sichtbar sind. Allerdings
        können trotzdem Informationen zu Ihrem Gerät, Standorteinstellungen und
      ...
      <p>
        Kommunikationsmöglichkeiten mit Ihnen sind für uns von großer Bedeutung.
        ...
        Kommunikation ist bei uns ein wichtiger Teil unserer Dienstleistung. Mit
        den praktischen Messenger- &amp; Kommunikationsfunktionen können Sie
        jederzeit jene wählen, die Ihnen am liebsten sind. In Ausnahmefällen
        kann es aber auch vorkommen, dass wir bestimmte Fragen über Chat bzw.
        Messenger nicht beantworten. Das ist der Fall, wenn es etwa um interne
      ...
      <p>
        ...
        Vereinbarung. Das Wesentliche der Vereinbarung ist weiter unten bei der
        betroffenen Plattform wiedergegeben.
      </p>
      <p>
        Bitte beachten Sie, dass bei der Nutzung unserer eingebauten Elemente
        auch Daten von Ihnen außerhalb der Europäischen Union verarbeitet werden
        können, da viele Anbieter, beispielsweise Facebook-Messenger oder
        WhatsApp amerikanische Unternehmen sind. Dadurch können Sie
      ...
      <p>
        ...
        jeweiligen Anbieter der Messenger- &amp; Kommunikationsfunktionen ab.
        Grundsätzlich handelt es sich um Daten wie etwa Name, Adresse,
        Telefonnummer, E-Mailadresse und Inhaltsdaten wie beispielsweise alle
        Informationen, die Sie in ein Kontaktformular eingeben. Meistens werden
        auch Informationen zu Ihrem Gerät und die IP-Adresse gespeichert. Daten,
        die über eine Messenger- &amp; Kommunikationsfunktion erhoben werden,
        werden auch auf den Servern der Anbieter gespeichert.
      </p>
      <p>
        Wenn Sie genau wissen wollen, welche Daten bei den jeweiligen Anbietern
      ...
      <p>
        ...
        Datenschutzerklärungen der Anbieter steht üblicherweise genau, welche
        ...
        Bereitstellung unserer Dienste nötig ist. Wenn Daten in Cookies
        gespeichert werden, variiert die Speicherdauer stark. Die Daten können
        gleich nach dem Verlassen einer Website wieder gelöscht werden, sie
        können aber auch über mehrere Jahre gespeichert bleiben. Daher sollten
      ...
      <p>
        ...
        deaktivieren oder löschen. Für weitere Informationen verweisen wir auf
        den Abschnitt zur Einwilligung.
      </p>
      <p>
        Da bei Messenger- &amp; Kommunikationsfunktionen Cookies zum Einsatz
        kommen können, empfehlen wir Ihnen auch unsere allgemeine
      ...
      <p>
        ...
        zu beantworten. Grundlage dafür ist
        <strong className="adsimple-312087504">
      ...
      <h2 id="whatsapp-datenschutzerklaerung" className="adsimple-312087504">
      ...
      <p>
        ...
        Tochterunternehmen von Meta Platforms Inc. Für den europäischen Raum ist
        das Unternehmen WhatsApp Ireland Limited, 4 Grand Canal Square, Grand
        Canal Harbour, Dublin 2, Irland verantwortlich.
      </p>
      <p>
        WhatsApp verarbeitet Daten von Ihnen u.a. auch in den USA. Wir weisen
        darauf hin, dass nach Meinung des Europäischen Gerichtshofs derzeit kein
        angemessenes Schutzniveau für den Datentransfer in die USA besteht. Dies
        kann mit verschiedenen Risiken für die Rechtmäßigkeit und Sicherheit der
        Datenverarbeitung einhergehen.
      ...
      <p>
        ...
        Drittstaaten (außerhalb der Europäischen Union, Island, Liechtenstein,
        Norwegen, also insbesondere in den USA) oder einer Datenweitergabe
        dorthin verwendet WhatsApp sogenannte Standardvertragsklauseln (= Art.
        46. Abs. 2 und 3 DSGVO). Standardvertragsklauseln (Standard Contractual
        Clauses – SCC) sind von der EU-Kommission bereitgestellte Mustervorlagen
        und sollen sicherstellen, dass Ihre Daten auch dann den europäischen
        Datenschutzstandards entsprechen, wenn diese in Drittländer (wie
        beispielsweise in die USA) überliefert und dort gespeichert werden.
        Durch diese Klauseln verpflichtet sich WhatsApp, bei der Verarbeitung
        Ihrer relevanten Daten, das europäische Datenschutzniveau einzuhalten,
        selbst wenn die Daten in den USA gespeichert, verarbeitet und verwaltet
        werden. Diese Klauseln basieren auf einem Durchführungsbeschluss der
        EU-Kommission. Sie finden den Beschluss und die entsprechenden
