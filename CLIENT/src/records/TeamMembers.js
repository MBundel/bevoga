...
const text = { 
    ...
    michel:'Michel ist seit 2022 Teammitglied bei Fimdeu und Hauptakteur dieser Homepage, u.a. Programmieren, Marketing, etc. Zuvor war er 4 Jahre selbstständiger Finanzberater bei MLP und hat sich nun auf die Digitalisierung von Maklerprozessen spezialisiert.',
    friedirch: ipsum,
    helmut:ipsum,
    fimdeu:"bevoga, die Berufsunfähigkeit ohne Gesundheitsfragen ist eine Marke der fimdeu UG (haftungsbeschränkt), dem Finanzdienstleister mit Niveau und Verstand.Um günstigen Gruppenvertragsprämien bei bevoga zu realisieren arbeiten, wir mit der Biometric Underwriting GmbH und der Netfonds AG zusammen. Die Netfonds AG unterstützt bevoga bei der Verwaltung Eurer Verträge. Die Biometric Underwriting GmbH  erstellt die Versicherungsscheine bzw. Policen für die Berufsunfähigkeitsversicherungen ohne Gesundheitsfragen.  Biometric Underwriting GmbH  als  Assekuradeur in Hamburg führt auch das Inkasso durch, zieht also die Beitragszahlungen ein. Das Produkt bBU Collect Plus von Biometric bildet die Grundlage für die Berufsunfähigkeitsversicherung ohne Gesundheitsfragen. Zusätzlich ist das Unternehmen neben den Spezialisten von fimdeu der kompetente Ansprechpartner, wenn es zu einer Berufsunfähigkeit kommt. Die Versicherer, die die Risiken für Biometric, sind nicht irgendwer, sondern Lloyd’s of Brussel (Sitz in Brüssel) und Sompo international. Lloyd´s und Sompo sind von Standard & Poor’s mit A+ ausgezeichnet. Die Unternehmen nutzen zur Rückversicherung der Risiken den internationalen Versicherungsmarkt, der seit 1686 besteht und sich heute aus rund 100 internationalen und renommierten Versicherungsunternehmen zusammensetzt. Selbstverständlich können alle dieser Unternehmungen beste Bonität aufweisen."
}
